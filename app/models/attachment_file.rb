...
class AttachmentFile < ApplicationRecord
  has_attached_file :upload,
                    ...
                    path: 'o_lms/public/system/contents/:content_folder_name/attachment_files/:filename',
                    url: 'o_lms/system/contents/:content_folder_name/attachment_files/:filename'
